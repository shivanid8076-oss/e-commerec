...
const TRUST_ITEMS = [
  {
    ic: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2"><path strokeLinecap="round" strokeLinejoin="round" d="M5 18h14M5 18a2 2 0 100-4 2 2 0 000 4zm14 0a2 2 0 100-4 2 2 0 000 4zM3 8h11v10H3V8zm11 0h3l4 4v6h-7V8z"/></svg>,
    ti: 'Complimentary Delivery',
    de: 'Seamless shipping across India'
  },
  {
    ic: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>,
    ti: 'Artisanal Craftsmanship',
    de: 'Every thread woven with pure devotion'
  },
  {
    ic: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>,
    ti: 'Secure Transactions',
    de: 'Encrypted checkout for your peace of mind'
  },
  {
    ic: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2"><path strokeLinecap="round" strokeLinejoin="round" d="M3 12a9 9 0 109-9 9.75 9.75 0 00-6.74 2.74L3 8M3 3v5h5"/></svg>,
    ti: 'Hassle-Free Returns',
    de: '7-day easy exchange & return policy'
  }
];
